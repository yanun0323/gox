...
//
// REPLACE CAUTION!!
func (elem *UpdatePhoneReq) ToEntity() *entity.UpdatePhoneReq { /* generate from entity  */
...
//
// REPLACE CAUTION!!
func (elem *UpdatePhoneReq) ToUseCase() *usecase.UpdatePhoneReq { /* generate from usecase  */
